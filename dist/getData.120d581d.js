...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"getData.js":[function(require,module,exports) {
"use strict";
...
function createTable(info) {
  ...
  info.forEach(item => {
    ...
    newRow.append(renderCellText(item.reminderMessage), renderCellText(item.cronInterval), renderCellText(item.lastTimeReminderExecuted));
    table.append(newRow);
  });
}

getReminders();
},{"babel-core/register":"node_modules/babel-core/register.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
